...
public class BruteForceCoding {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("\nEncoded message: " + byteArrayToDecimalString(msg));

        ByteArrayInputStream bufIn = new ByteArrayInputStream(msg);
        DataInputStream in = new DataInputStream(bufIn);
        byte readByteVal = in.readByte();
        short readShortVal = in.readShort();
        int readIntVal = in.readInt();
        long readLongVal = in.readLong();

        System.out.print("\nRead values : ");
        System.out.print("Byte = " + readByteVal);
        System.out.print(", Short = " + readShortVal);
        System.out.print(", Int = " + readIntVal);
        System.out.print(", Long = " + readLongVal);
